...
(
   ...
   input logic clock2x,
   input logic resetn,
   // AVS avs_gradient_cra
   input logic avs_gradient_cra_enable,
   input logic avs_gradient_cra_read,
   input logic avs_gradient_cra_write,
   input logic [3:0] avs_gradient_cra_address,
   input logic [63:0] avs_gradient_cra_writedata,
   input logic [7:0] avs_gradient_cra_byteenable,
   output logic [63:0] avs_gradient_cra_readdata,
   output logic avs_gradient_cra_readdatavalid,
   ...
   // INST gradient_std_ic_inst of gradient_std_ic_partition_wrapper
   gradient_std_ic_partition_wrapper gradient_std_ic_inst
   (
      .clock(clock),
      .clock2x(clock2x),
      .resetn(resetn),
      .cra_irq_gradient(kernel_irqs),
      // AVS avs_gradient_cra
      .avs_gradient_cra_enable(avs_gradient_cra_enable),
      .avs_gradient_cra_read(avs_gradient_cra_read),
      .avs_gradient_cra_write(avs_gradient_cra_write),
      .avs_gradient_cra_address(avs_gradient_cra_address),
      .avs_gradient_cra_writedata(avs_gradient_cra_writedata),
      .avs_gradient_cra_byteenable(avs_gradient_cra_byteenable),
      .avs_gradient_cra_readdata(avs_gradient_cra_readdata),
      .avs_gradient_cra_readdatavalid(avs_gradient_cra_readdatavalid),
      // AVM gradient_0_avm_unnamed_gradient0
      .gradient_0_avm_unnamed_gradient0_enable(gmem0_global_avm_enable[0]),
      .gradient_0_avm_unnamed_gradient0_read(gmem0_global_avm_read[0]),
      .gradient_0_avm_unnamed_gradient0_write(gmem0_global_avm_write[0]),
      .gradient_0_avm_unnamed_gradient0_burstcount(gmem0_global_avm_burstcount[0]),
      .gradient_0_avm_unnamed_gradient0_address(gmem0_global_avm_address[0]),
      .gradient_0_avm_unnamed_gradient0_writedata(gmem0_global_avm_writedata[0]),
      .gradient_0_avm_unnamed_gradient0_byteenable(gmem0_global_avm_byteenable[0]),
      .gradient_0_avm_unnamed_gradient0_waitrequest(gmem0_global_avm_waitrequest[0]),
      .gradient_0_avm_unnamed_gradient0_readdata(gmem0_global_avm_readdata[0]),
      .gradient_0_avm_unnamed_gradient0_readdatavalid(gmem0_global_avm_readdatavalid[0]),
      .gradient_0_avm_unnamed_gradient0_writeack(gmem0_global_avm_writeack[0]),
      // AVM gradient_0_avm_unnamed_gradient1
      .gradient_0_avm_unnamed_gradient1_enable(gmem0_global_avm_enable[1]),
      .gradient_0_avm_unnamed_gradient1_read(gmem0_global_avm_read[1]),
      .gradient_0_avm_unnamed_gradient1_write(gmem0_global_avm_write[1]),
      .gradient_0_avm_unnamed_gradient1_burstcount(gmem0_global_avm_burstcount[1]),
      .gradient_0_avm_unnamed_gradient1_address(gmem0_global_avm_address[1]),
      .gradient_0_avm_unnamed_gradient1_writedata(gmem0_global_avm_writedata[1]),
      .gradient_0_avm_unnamed_gradient1_byteenable(gmem0_global_avm_byteenable[1]),
      .gradient_0_avm_unnamed_gradient1_waitrequest(gmem0_global_avm_waitrequest[1]),
      .gradient_0_avm_unnamed_gradient1_readdata(gmem0_global_avm_readdata[1]),
      .gradient_0_avm_unnamed_gradient1_readdatavalid(gmem0_global_avm_readdatavalid[1]),
      .gradient_0_avm_unnamed_gradient1_writeack(gmem0_global_avm_writeack[1])
   );
...
/////////////////////////////////////////////////////////////////
// MODULE gradient_std_ic_partition_wrapper
/////////////////////////////////////////////////////////////////
module gradient_std_ic_partition_wrapper
(
   input logic clock,
   ...
   output logic avs_gradient_cra_readdatavalid,
   // AVM gradient_0_avm_unnamed_gradient0
   output logic gradient_0_avm_unnamed_gradient0_enable,
   output logic gradient_0_avm_unnamed_gradient0_read,
   output logic gradient_0_avm_unnamed_gradient0_write,
   output logic [4:0] gradient_0_avm_unnamed_gradient0_burstcount,
   output logic [29:0] gradient_0_avm_unnamed_gradient0_address,
   output logic [255:0] gradient_0_avm_unnamed_gradient0_writedata,
   output logic [31:0] gradient_0_avm_unnamed_gradient0_byteenable,
   input logic gradient_0_avm_unnamed_gradient0_waitrequest,
   input logic [255:0] gradient_0_avm_unnamed_gradient0_readdata,
   input logic gradient_0_avm_unnamed_gradient0_readdatavalid,
   input logic gradient_0_avm_unnamed_gradient0_writeack,
   // AVM gradient_0_avm_unnamed_gradient1
   output logic gradient_0_avm_unnamed_gradient1_enable,
   output logic gradient_0_avm_unnamed_gradient1_read,
   output logic gradient_0_avm_unnamed_gradient1_write,
   output logic [4:0] gradient_0_avm_unnamed_gradient1_burstcount,
   output logic [29:0] gradient_0_avm_unnamed_gradient1_address,
   output logic [255:0] gradient_0_avm_unnamed_gradient1_writedata,
   output logic [31:0] gradient_0_avm_unnamed_gradient1_byteenable,
   input logic gradient_0_avm_unnamed_gradient1_waitrequest,
   input logic [255:0] gradient_0_avm_unnamed_gradient1_readdata,
   input logic gradient_0_avm_unnamed_gradient1_readdatavalid,
   input logic gradient_0_avm_unnamed_gradient1_writeack
);
   logic gradient_start;
   logic [0:0] gradient_start_chain;
   logic [0:0] gradient_start_kernel_copy;
   logic [0:0] gradient_start_task_fd;
   logic [0:0] gradient_start_finish_element;
   logic gradient_finish;
   logic [0:0] gradient_finish_kernel_copy;
   logic [0:0] gradient_finish_chain;
   logic [31:0] gradient_global_size [2:0];
   logic [31:0] gradient_num_groups [2:0];
   logic [31:0] gradient_local_size [2:0];
   logic [31:0] gradient_global_offset [2:0];
   logic [31:0] gradient_work_dim;
   logic [31:0] gradient_wg_size;
   logic [0:0] gradient_wg_disp_stall_in;
   logic [0:0] gradient_wg_disp_stall_in_lookahead;
   logic [0:0] gradient_wg_disp_valid_out;
   logic gradient_wg_disp_start_out;
   logic [31:0] gradient_wg_disp_group_id_out [2:0];
   logic [31:0] gradient_wg_disp_global_id_base_out [2:0];
   logic gradient_wg_disp_dispatched_all_groups;
   logic [31:0] gradient_global_id [1][2:0];
   logic [31:0] gradient_local_id [1][2:0];
   logic [31:0] gradient_group_id [1][2:0];
   logic [0:0] gradient_pending_write;
   logic [0:0] gradient_lsu_active;
   logic [0:0] gradient_valid_in;
   logic [0:0] gradient_valid_out;
   logic [0:0] gradient_stall_in;
   logic [0:0] gradient_stall_out;
   logic gradient_cra_pending_write;
   logic gradient_cra_lsu_active;
   logic gradient_cra_valid_in;
   logic [191:0] gradient_kernel_arguments;

   assign gradient_start_chain[0] = gradient_start;
   assign gradient_finish_chain[0] = 1'b1;
   assign gradient_cra_pending_write = |gradient_pending_write;
   assign gradient_cra_lsu_active = |gradient_lsu_active;
   assign gradient_cra_valid_in = |gradient_valid_in;
   assign gradient_stall_in = 0;
   // INST gradient_workgroup_dispatcher of acl_work_group_dispatcher
   ...
   gradient_workgroup_dispatcher
   (
      .clock(clock),
      .resetn(resetn),
      .start(gradient_start),
      .num_groups(gradient_num_groups),
      .local_size(gradient_local_size),
      .stall_in(gradient_wg_disp_stall_in),
      .stall_in_lookahead(gradient_wg_disp_stall_in_lookahead),
      .valid_out(gradient_wg_disp_valid_out),
      .group_id_out(gradient_wg_disp_group_id_out),
      .global_id_base_out(gradient_wg_disp_global_id_base_out),
      .start_out(gradient_wg_disp_start_out),
      .dispatched_all_groups(gradient_wg_disp_dispatched_all_groups)
   );

   // INST gradient_finish_detector of acl_kernel_finish_detector
   ...
   gradient_finish_detector
   (
      .clock(clock),
      .resetn(resetn),
      .start(gradient_start),
      .wg_size(gradient_wg_size),
      .wg_dispatch_valid_out(gradient_wg_disp_valid_out),
      .wg_dispatch_stall_in(gradient_wg_disp_stall_in),
      .dispatched_all_groups(gradient_wg_disp_dispatched_all_groups),
      .kernel_copy_valid_out(gradient_valid_out),
      .kernel_copy_stall_in(gradient_stall_in),
      .pending_writes(gradient_cra_pending_write),
      .finish(gradient_finish)
   );

   // INST gradient_cra_slave_inst of gradient_function_cra_slave
   gradient_function_cra_slave gradient_cra_slave_inst
   (
      .clock(clock),
      .resetn(resetn),
      .start(gradient_start),
      .finish(gradient_finish),
      .global_offset_0(gradient_global_offset[0]),
      .global_offset_1(gradient_global_offset[1]),
      .global_offset_2(gradient_global_offset[2]),
      .work_dim(gradient_work_dim),
      .has_a_lsu_active(gradient_cra_lsu_active),
      .has_a_write_pending(gradient_cra_pending_write),
      .valid_in(gradient_cra_valid_in),
      .global_size_0(gradient_global_size[0]),
      .global_size_1(gradient_global_size[1]),
      .global_size_2(gradient_global_size[2]),
      .num_groups_0(gradient_num_groups[0]),
      .num_groups_1(gradient_num_groups[1]),
      .num_groups_2(gradient_num_groups[2]),
      .local_size_0(gradient_local_size[0]),
      .local_size_1(gradient_local_size[1]),
      .local_size_2(gradient_local_size[2]),
      .workgroup_size(gradient_wg_size),
      .kernel_arguments(gradient_kernel_arguments),
      .cra_irq(cra_irq_gradient),
      // AVS avs_cra
      .avs_cra_enable(avs_gradient_cra_enable),
      .avs_cra_read(avs_gradient_cra_read),
      .avs_cra_write(avs_gradient_cra_write),
      .avs_cra_address(avs_gradient_cra_address),
      .avs_cra_writedata(avs_gradient_cra_writedata),
      .avs_cra_byteenable(avs_gradient_cra_byteenable),
      .avs_cra_readdata(avs_gradient_cra_readdata),
      .avs_cra_readdatavalid(avs_gradient_cra_readdatavalid)
   );

   // INST gradient_id_iter_inst_0 of acl_id_iterator
   acl_id_iterator
   #(
      .WIDTH(32),
      .LOCAL_WIDTH_X(32),
   ...
   gradient_id_iter_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start(gradient_wg_disp_start_out),
      .valid_in(gradient_wg_disp_valid_out[0]),
      .stall_out(gradient_wg_disp_stall_in[0]),
      .stall_out_lookahead(gradient_wg_disp_stall_in_lookahead[0]),
      .stall_in(gradient_stall_out[0]),
      .valid_out(gradient_valid_in[0]),
      .group_id_in(gradient_wg_disp_group_id_out),
      .global_id_base_in(gradient_wg_disp_global_id_base_out),
      .local_size(gradient_local_size),
      .global_size(gradient_global_size),
      .local_id(gradient_local_id[0]),
      .global_id(gradient_global_id[0]),
      .group_id(gradient_group_id[0])
   );

   // INST gradient_inst_0 of gradient_top_wrapper_0
   gradient_top_wrapper_0 gradient_inst_0
   (
      .start(gradient_start_kernel_copy[0]),
      .kernel_arguments(gradient_kernel_arguments),
      .work_dim(gradient_work_dim),
      .global_offset(gradient_global_offset),
      .kernel_valid_out(gradient_valid_out[0]),
      .has_a_write_pending(gradient_pending_write[0]),
      .has_a_lsu_active(gradient_lsu_active[0]),
      .global_id(gradient_global_id[0]),
      .local_id(gradient_local_id[0]),
      .group_id(gradient_group_id[0]),
      .global_size(gradient_global_size),
      ...
      .num_groups(gradient_num_groups),
      .workgroup_size(gradient_wg_size),
      .kernel_stall_out(gradient_stall_out[0]),
      .kernel_valid_in(gradient_valid_in[0]),
      .clock(clock),
      .resetn(resetn),
      .clock2x(clock2x),
      // AVM avm_unnamed_gradient0
      .avm_unnamed_gradient0_enable(gradient_0_avm_unnamed_gradient0_enable),
      .avm_unnamed_gradient0_read(gradient_0_avm_unnamed_gradient0_read),
      .avm_unnamed_gradient0_write(gradient_0_avm_unnamed_gradient0_write),
      .avm_unnamed_gradient0_burstcount(gradient_0_avm_unnamed_gradient0_burstcount),
      .avm_unnamed_gradient0_address(gradient_0_avm_unnamed_gradient0_address),
      .avm_unnamed_gradient0_writedata(gradient_0_avm_unnamed_gradient0_writedata),
      .avm_unnamed_gradient0_byteenable(gradient_0_avm_unnamed_gradient0_byteenable),
      .avm_unnamed_gradient0_waitrequest(gradient_0_avm_unnamed_gradient0_waitrequest),
      .avm_unnamed_gradient0_readdata(gradient_0_avm_unnamed_gradient0_readdata),
      .avm_unnamed_gradient0_readdatavalid(gradient_0_avm_unnamed_gradient0_readdatavalid),
      .avm_unnamed_gradient0_writeack(gradient_0_avm_unnamed_gradient0_writeack),
      // AVM avm_unnamed_gradient1
      .avm_unnamed_gradient1_enable(gradient_0_avm_unnamed_gradient1_enable),
      .avm_unnamed_gradient1_read(gradient_0_avm_unnamed_gradient1_read),
      .avm_unnamed_gradient1_write(gradient_0_avm_unnamed_gradient1_write),
      .avm_unnamed_gradient1_burstcount(gradient_0_avm_unnamed_gradient1_burstcount),
      .avm_unnamed_gradient1_address(gradient_0_avm_unnamed_gradient1_address),
      .avm_unnamed_gradient1_writedata(gradient_0_avm_unnamed_gradient1_writedata),
      .avm_unnamed_gradient1_byteenable(gradient_0_avm_unnamed_gradient1_byteenable),
      .avm_unnamed_gradient1_waitrequest(gradient_0_avm_unnamed_gradient1_waitrequest),
      .avm_unnamed_gradient1_readdata(gradient_0_avm_unnamed_gradient1_readdata),
      .avm_unnamed_gradient1_readdatavalid(gradient_0_avm_unnamed_gradient1_readdatavalid),
      .avm_unnamed_gradient1_writeack(gradient_0_avm_unnamed_gradient1_writeack)
   );

   // INST gradient_start_elem_inst_0 of acl_start_signal_chain_element
   acl_start_signal_chain_element
   #(
      .ASYNC_RESET(1),
      .SYNCHRONIZE_RESET(0)
   )
   gradient_start_elem_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start_in(gradient_start_chain[0]),
      .start_kernel(gradient_start_kernel_copy[0]),
      .start_finish_detector(gradient_start_task_fd[0]),
      .start_finish_chain_element(gradient_start_finish_element[0]),
      .start_chain()
   );
...
(
   ...
   input logic clock2x,
   // AVM avm_unnamed_gradient0
   output logic avm_unnamed_gradient0_enable,
   output logic avm_unnamed_gradient0_read,
   output logic avm_unnamed_gradient0_write,
   output logic [4:0] avm_unnamed_gradient0_burstcount,
   output logic [29:0] avm_unnamed_gradient0_address,
   output logic [255:0] avm_unnamed_gradient0_writedata,
   output logic [31:0] avm_unnamed_gradient0_byteenable,
   input logic avm_unnamed_gradient0_waitrequest,
   input logic [255:0] avm_unnamed_gradient0_readdata,
   input logic avm_unnamed_gradient0_readdatavalid,
   input logic avm_unnamed_gradient0_writeack,
   // AVM avm_unnamed_gradient1
   output logic avm_unnamed_gradient1_enable,
   output logic avm_unnamed_gradient1_read,
   output logic avm_unnamed_gradient1_write,
   output logic [4:0] avm_unnamed_gradient1_burstcount,
   output logic [29:0] avm_unnamed_gradient1_address,
   output logic [255:0] avm_unnamed_gradient1_writedata,
   output logic [31:0] avm_unnamed_gradient1_byteenable,
   input logic avm_unnamed_gradient1_waitrequest,
   input logic [255:0] avm_unnamed_gradient1_readdata,
   input logic avm_unnamed_gradient1_readdatavalid,
   input logic avm_unnamed_gradient1_writeack
);
   logic lmem_invalid_single_bit;

   // INST kernel of gradient_function_wrapper
   gradient_function_wrapper kernel
   (
      ...
      .clock2x(clock2x),
      // AVM avm_unnamed_gradient0
      .avm_unnamed_gradient0_enable(avm_unnamed_gradient0_enable),
      .avm_unnamed_gradient0_read(avm_unnamed_gradient0_read),
      .avm_unnamed_gradient0_write(avm_unnamed_gradient0_write),
      .avm_unnamed_gradient0_burstcount(avm_unnamed_gradient0_burstcount),
      .avm_unnamed_gradient0_address(avm_unnamed_gradient0_address),
      .avm_unnamed_gradient0_writedata(avm_unnamed_gradient0_writedata),
      .avm_unnamed_gradient0_byteenable(avm_unnamed_gradient0_byteenable),
      .avm_unnamed_gradient0_waitrequest(avm_unnamed_gradient0_waitrequest),
      .avm_unnamed_gradient0_readdata(avm_unnamed_gradient0_readdata),
      .avm_unnamed_gradient0_readdatavalid(avm_unnamed_gradient0_readdatavalid),
      .avm_unnamed_gradient0_writeack(avm_unnamed_gradient0_writeack),
      // AVM avm_unnamed_gradient1
      .avm_unnamed_gradient1_enable(avm_unnamed_gradient1_enable),
      .avm_unnamed_gradient1_read(avm_unnamed_gradient1_read),
      .avm_unnamed_gradient1_write(avm_unnamed_gradient1_write),
      .avm_unnamed_gradient1_burstcount(avm_unnamed_gradient1_burstcount),
      .avm_unnamed_gradient1_address(avm_unnamed_gradient1_address),
      .avm_unnamed_gradient1_writedata(avm_unnamed_gradient1_writedata),
      .avm_unnamed_gradient1_byteenable(avm_unnamed_gradient1_byteenable),
      .avm_unnamed_gradient1_waitrequest(avm_unnamed_gradient1_waitrequest),
      .avm_unnamed_gradient1_readdata(avm_unnamed_gradient1_readdata),
      .avm_unnamed_gradient1_readdatavalid(avm_unnamed_gradient1_readdatavalid),
      .avm_unnamed_gradient1_writeack(avm_unnamed_gradient1_writeack)
   );
...
(
   ...
   begin:gmem0_
      ...
      // INST global_ic_preroutegmem0_router_0 of gradient_system_interconnect_0
      gradient_system_interconnect_0 global_ic_preroutegmem0_router_0
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_ic_preroutegmem0_router_1 of gradient_system_interconnect_1
      gradient_system_interconnect_1 global_ic_preroutegmem0_router_1
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_icgmem0_port_0_0_rw of gradient_system_interconnect_2
      gradient_system_interconnect_2 global_icgmem0_port_0_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE gradient_system_interconnect_0
/////////////////////////////////////////////////////////////////
module gradient_system_interconnect_0
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE gradient_system_interconnect_1
/////////////////////////////////////////////////////////////////
module gradient_system_interconnect_1
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE gradient_system_interconnect_2
/////////////////////////////////////////////////////////////////
module gradient_system_interconnect_2
(
   input logic clock,
